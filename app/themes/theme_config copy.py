THEMES = {
    ...
    'neon': {
        ...
        'buttons': {
            'primary': 'bg-purple-600 hover:bg-purple-700 text-green-200 shadow-lg shadow-purple-500/50',
    ...
    'futurist': {
        ...
        'buttons': {
            'primary': 'bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-blue-500/30 shadow-lg',
